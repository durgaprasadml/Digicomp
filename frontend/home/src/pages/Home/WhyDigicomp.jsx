...
const Mag = () => <svg preserveAspectRatio="xMidYMid meet" className="max-h-full" fill="none" viewBox="0 0 397 407"><g transform="translate(39.7 40.7) scale(0.8)"><path fill="url(#radialBlue)" stroke="#0072dc" strokeWidth="8" d="M162 4a158 158 0 1 1 0 317 158 158 0 0 1 0-317Z"/><circle cx="147.9" cy="85.2" r="50.6" fill="var(--surface)"/><path stroke="#0072dc" strokeLinecap="round" strokeWidth="16" d="M6-6h163" transform="rotate(225 281 118)"/><defs><radialGradient id="radialBlue" cx="162" cy="162" r="162" gradientUnits="userSpaceOnUse"><stop stopColor="var(--color-accent-soft-hover)" stopOpacity=".1"/><stop offset="1" stopColor="var(--color-accent-soft-hover)"/></radialGradient></defs></g></svg>
